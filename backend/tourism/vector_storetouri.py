...
PDF_PATH = "C:/Users/simaa/OneDrive/Desktop/rag/3ish-Tounis/tourism/data/Tourist guide_205_2018-12-17_8675-a4.pdf"
...
def save_faiss_index(embeddings, chunks, index_path="faiss_indextouri"):
    """Save embeddings to FAISS"""
    dimension = embeddings.shape[1]
    index = faiss.IndexFlatL2(dimension)
    index.add(embeddings)

    with open("embeddingstouri.pkl", "wb") as f:
        pickle.dump(chunks, f)

    faiss.write_index(index, index_path)

def load_faiss_index(index_path="faiss_indextouri"):
    """Load FAISS index"""
